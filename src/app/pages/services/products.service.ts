...
export class ProductsService {
  ...
  activateProduct(id) {
    return this.http.post(this.url + '/products/' + id + '/activate', {})
        .catch((error: any) => {
  ...
  deactivateProduct(id, data) {
      return this.http.post(this.url + '/products/' + id + '/deactivate', data)
          .catch((error: any) => {
              return Observable.throw(error.error || 'Server error');
          });
  }
  ...
  uploadFile(file) {
    ...
    return  this.http.post(this.url + '/products/import', fd)
      .catch((error: any) => {
