...
export class AffiliateService {
  ...
  getUserRequests(data) {
    return this.http
      .get(this.url + "/requests", { params: data })
      .catch((error: any) => {
  ...
  userApprove(id) {
    return this.http
      .post(this.url + "/requests/" + id + "/approve", id)
      .catch((error: any) => {
        throw error.error || "Server error";
      });
  }
  userReject(id, message) {
    return this.http
      .post(this.url + "/requests/" + id + "/reject", {
  ...
  getDeliverersId(id) {
    return this.http.get(this.url + "/" + id).catch((error: any) => {
      throw error.error || "Server error";
    });
  }
  ...
  getAllAffiliate(q) {
    return this.http.get(this.url + "?q=" + q).catch((error: any) => {
  ...
  getAffiliatesList(data) {
    return this.http
      .get(this.wallet_store, { params: data })
      .catch((error: any) => {
        throw error.error || "Server error";
      });
  }
  ...
  addAdminCredit(data) {
    return this.http.post(this.wallet_store, data).catch((error: any) => {
      throw error.error || "Server error";
    });
  }
  ...
  affiliateWithdrawApprove(id) {
    return this.http
      .post(this.wallet_store + "/" + id + "/approve", id)
      .catch((error: any) => {
        throw error.error || "Server error";
      });
  }
  affiliateWithdrawReject(id, message) {
    return this.http
      .post(this.wallet_store + "/" + id + "/reject", {
        rejection_reason: message,
      })
      .catch((error: any) => {
        throw error.error || "Server error";
  ...
  createAffiliate(data) {
    return this.http.post(this.url, data).catch((error: any) => {
      return Observable.throw(error.error || "Server error");
    });
  }

  updateAffiliate(id, data) {
    return this.http.put(this.url + "/" + id, data).catch((error: any) => {
      return Observable.throw(error.error || "Server error");
    });
  }
  exportFile(url) {
