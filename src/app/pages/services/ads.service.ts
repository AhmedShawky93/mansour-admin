...
export class AdsService {
  ...
  getAdsId(ad) {
    return this.http.get(this.url + 'ads/' + ad)
      .catch((error: any) => {
        return Observable.throw(error.error || 'error ads')
      })
  }
  creatAds(ad) {
    return this.http.post(this.url + 'ads', ad)
      .catch((error: any) => {
        return Observable.throw(error.error || 'error ads')
      })
  }
  updateAds(id, data) {
    return this.http.put(this.url + 'ads/' + id, data)
      .catch((error: any) => {
        return Observable.throw(error.error || 'error ads')
      })
  }
  ...
  deactivateAd(id, data) {
    return this.http.post(this.url + "ads/" + id + "/deactivate", data)
      .catch((error: any) => {
        return Observable.throw(error.error || 'Server error');
      })
  }
