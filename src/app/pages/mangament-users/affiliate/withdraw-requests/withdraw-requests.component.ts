...
export class WithdrawRequestsComponent implements OnInit {
  ...
  constructor(private affiliateService: AffiliateService, public dialog: MatDialog,
  ...
  filterAffiliates(product: any = null, search: any = null) {
    ...
    this.spinner.show();
    this.affiliateService.getAffiliatesList
      (search)
      .subscribe((response: any) => {
        this.walletHistoryAffiliates = response.data.wallet;
        this.walletHistoryAffiliates = this.walletHistoryAffiliates.map((item) => {
